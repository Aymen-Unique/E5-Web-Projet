...
<!-- Mirrored from template.hasthemes.com/flone/flone/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Dec 2021 08:51:04 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="custom-row-2">
            ...
            <div class="col-lg-8 col-md-7">
                <div class="contact-form">
                    ...
                    <form class="contact-form-style" id="contact-form" action="{{route('save')}}" method="post">
                        <div class="row">
                            <div class="col-lg-6">
